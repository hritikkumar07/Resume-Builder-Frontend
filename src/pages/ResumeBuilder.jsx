...
import { ArrowLeft, ArrowLeftIcon, Briefcase, ChevronLeft, ChevronRight, CloudSnow, Download, EyeIcon, EyeOffIcon, FileText, FolderIcon, GraduationCap, Share2Icon, Sparkles, User } from 'lucide-react'
        ...
        {/* Left Panel - form */}
          <div className='relative lg:col-span-5 rounded-lg overflow-hidden'>
            <div className='bg-white rounded-lg shadow-sm border border-gray-200 p-6 pt-1'>
              ...
              <hr className='absolute top-0 left-0 right-0 -2 border-gray-200'/>
            ...
            <div className='relative w-full'>
              <div className='absolute bottom-3 left-0 right-0 flex items-center justify-end gap-2'>
                {resumeData.public &&  (
                  ...
                  </button> /*This button will be displayed when the resume is public */
                )}

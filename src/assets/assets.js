...
export const dummyResumeData = [
    {
        ...
        extracurriculars: ["Volunteer Mentor - Code Club", "Hackathon Winner - Local Tech Fest"],
        experience: [
            {
    ...
    },
    {
        ...
        extracurriculars: ["Design Lead - UI/UX Meetup", "Workshop Speaker - Frontend Basics"],
        experience: [
            {
    ...
    },
    {
        ...
        extracurriculars: ["Open Source Contributor", "Tech Blog Writer"],
        experience: [
            {

...
const PersonalInfoForm = ({data, onChange, removeBackground, setRemoveBackground}) => {
    ...
    const fields = [
         ...
         { key:"email", label:"Email Address", icon: Mail, type: "email", required:true},
           ...
           { key:"phone", label:"Phone Number", icon: Phone, type: "telephone"},
  ...
  return (
    <div>
        ...
        <p className='text-sm text-gray-600'>Start by Entering Your Personal Details </p>
            ...
            {typeof data.image === 'object' && (
                <div className='flex flex-col gap-1 pl-4 text-sm'>
                    ...
                    <label className='relative inline-flex items-center cursor-pointer text-gray-900 gap-3'>
                        ...
                        <span className='dot absolute left-1 top-1 w-3 h-3 bg-white rounded-full transition-transform duration-200 ease-in-out peer-cheked:translate-x-4'></span>

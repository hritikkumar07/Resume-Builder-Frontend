            ...
            <div className="min-h-screen pb-20">
                ...
                <nav className="z-50 flex items-center justify-between w-full py-4 px-6 md:px-16 lg:px-24 xl:px-40 text-sm">
                    ...
                    <div className="hidden md:flex items-center gap-8 transition duration-500 text-slate-800">
                        <a href="#home" className="hover:text-blue-600 font-medium transition">Home</a>
                        <a href="#features" className="hover:text-blue-600 font-medium transition">Features</a>
                        <a href="#testimonials" className="hover:text-blue-600 font-medium transition">Testimonials</a>
                        <a href="#cta" className="hover:text-blue-600 font-medium transition">Contact</a>
                    </div>
                    ...
                    <div className="flex gap-2">
                        ...
                        {user && (
                            <Link to='/app' className='hidden md:block px-8 py-2 bg-blue-500 hover:bg-blue-700 active:scale-95 transition-all rounded-full text-white'>
                                Dashboard
                            </Link>
                        )}
                    </div>
                ...
                <div className="relative flex flex-col items-center justify-center text-sm px-4 md:px-16 lg:px-24 xl:px-40 text-black">
                    ...
                    <div className="flex flex-wrap justify-between max-sm:justify-center gap-6 max-w-3xl w-full mx-auto py-4" id="logo-container">
                        {logos.map((logo, index) => <img key={index} src={logo} alt="logo" className="h-25 w-10 max-w-xl" />)}
                    </div>
                </div>
            </div>
            <style>

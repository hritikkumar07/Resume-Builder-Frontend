    ...
    <>
     <style>{`
            ...
            `}</style>
                     ...
                     <footer className="flex flex-col items-center justify-center w-full py-20 bg-gradient-to-b from-[#1B004D] to-[#2E0A6F] text-white">
                        <div>
                ...
                <div className="flex items-center gap-4 mt-5">
                    ...
                    <a href="https://www.linkedin.com/in/hritik-naik/" className="hover:-translate-y-0.5 transition-all duration-300">
                    ...
                    <a href="https://x.com/Hritik_Naik_20" className="hover:-translate-y-0.5 transition-all duration-300">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="https://github.com/hritikkumar07" className="hover:-translate-y-0.5 transition-all duration-300">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
